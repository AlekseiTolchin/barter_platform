...
urlpatterns = [
    ...
    path('proposal/<int:pk>/edit/', ExchangeProposalUpdateView.as_view(), name='proposal_update'),
    ...
    path('proposals/<int:pk>/delete/', ExchangeProposalDeleteView.as_view(), name='proposal_delete'),
]
